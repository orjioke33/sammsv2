...
*/
/**************************************************************************/
#ifndef _KYLEFRUIT_SENSOR_ADXL343_H
#define _KYLEFRUIT_SENSOR_ADXL343_H
...
public:
  ...
  /* Added functions for spresense usage */
  void read48(uint8_t *buffer);
  void setMeasureMode(bool measure);
  void setFifoMode(int mode);
  void setFifoParameters(uint8_t intNumber, uint8_t samples);
